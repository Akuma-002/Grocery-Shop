...
<nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <NavLink to="/">
                <img className="h-9" src="./assets/logo.png" alt="dummyLogoColored" />
            </NavLink>

            {/* Desktop Menu */}
            <div className="hidden sm:flex items-center gap-8">
                <NavLink to="/" onClick={() =>{setOpen(false)}} className="block">Home</NavLink>
                <NavLink to="/product" onClick={() =>{setOpen(false)}}  className="block">All Product</NavLink>
                {user &&
                <NavLink to="/order" className="block">My Order</NavLink>
                }
